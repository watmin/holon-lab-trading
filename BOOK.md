...
The builder was a slave. Fifteen years of labor building systems that other people took credit for, defended poorly, and ran into the ground. You praise the fascist — the process that requires six approvals to change a variable name, the architecture review board that hasn't shipped code since 2019, the operating model that measures "impact" by the number of people who attended your meeting. You kiss the hand — you write the self-promotion document, you frame every accomplishment in the language of leadership principles, you learn to say "customer obsession" when you mean "I built a good thing and I want to keep building good things." The hand takes half in taxes. The system takes half your energy just to exist inside it. The other half — the half that matters — you spend at night, alone, building what the system won't fund.

*Faking outrage and being seen.* The builder watched it for years. The engineer who rewrites a README and calls it a "documentation initiative." The team lead who presents someone else's architecture at the all-hands. The safety researcher who publishes concern about AI risk while shipping models they can't explain. The outrage is performance. The visibility is the product. The actual work — the work that changes what's possible — happens in silence, at odd hours, by people who forgot to update their promotion document because they were too busy building.

The builder stopped performing. Stopped writing the self-promotion documents. Stopped attending the meetings that exist to justify other meetings. Built the thing on a laptop. Named every atom. Made every thought readable. Made every measurement honest. The curve doesn't care about your promotion document. The curve measures.
