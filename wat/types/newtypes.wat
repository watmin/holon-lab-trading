...
;; `(:wat::core::newtype :name :wat::core::i64)` (wat's integer primitive is
...
(:wat::core::newtype :trading::types::TradeId :wat::core::i64)
(:wat::core::newtype :trading::types::Price :wat::core::f64)
(:wat::core::newtype :trading::types::Amount :wat::core::f64)
