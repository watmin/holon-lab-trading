...
(:wat::core::define
  (:trading::encoding::detect-divergence
    ...
    -> :(f64,f64))
  (:wat::core::let*
    (((p-len :i64) (:wat::core::length prices))
     ((r-len :i64) (:wat::core::length rsis))
     ((n :i64)
      (:wat::core::if (:wat::core::< p-len r-len) -> :i64 p-len r-len)))
    (:wat::core::if (:wat::core::< n 5) -> :(f64,f64)
      (:wat::core::tuple 0.0 0.0)
      (:wat::core::let*
        (((half :i64) (:wat::core::/ n 2))
         ...
         ((p-low-1 :f64)
          (:wat::core::match (:wat::core::f64::min-of first-prices) -> :f64
            ((Some v) v) (:None 0.0)))
         ((p-low-2 :f64)
          (:wat::core::match (:wat::core::f64::min-of second-prices) -> :f64
            ((Some v) v) (:None 0.0)))
         ((rsi-low-1 :f64)
          (:wat::core::match (:wat::core::f64::min-of first-rsis) -> :f64
            ((Some v) v) (:None 0.0)))
         ((rsi-low-2 :f64)
          (:wat::core::match (:wat::core::f64::min-of second-rsis) -> :f64
            ((Some v) v) (:None 0.0)))
         ((p-high-1 :f64)
          (:wat::core::match (:wat::core::f64::max-of first-prices) -> :f64
            ((Some v) v) (:None 0.0)))
         ((p-high-2 :f64)
          (:wat::core::match (:wat::core::f64::max-of second-prices) -> :f64
            ((Some v) v) (:None 0.0)))
         ((rsi-high-1 :f64)
          (:wat::core::match (:wat::core::f64::max-of first-rsis) -> :f64
            ((Some v) v) (:None 0.0)))
         ((rsi-high-2 :f64)
          (:wat::core::match (:wat::core::f64::max-of second-rsis) -> :f64
            ((Some v) v) (:None 0.0)))
         ;; Bull: price lower low + RSI higher low.
         ((bull :f64)
          (:wat::core::if (:wat::core::and
                            (:wat::core::< p-low-2 p-low-1)
                            (:wat::core::> rsi-low-2 rsi-low-1)) -> :f64
            (:wat::core::f64::abs
              (:wat::core::-
                (:wat::core::- p-low-2 p-low-1)
         ...
         ((bear :f64)
          (:wat::core::if (:wat::core::and
                            ...
                            (:wat::core::< rsi-high-2 rsi-high-1)) -> :f64
            (:wat::core::f64::abs
              (:wat::core::-
                (:wat::core::- p-high-2 p-high-1)
