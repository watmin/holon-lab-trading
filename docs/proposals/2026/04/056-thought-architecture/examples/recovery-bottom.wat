...
(define phase-0 (encode (bundle                            ;; the crash
...
(define phase-1 (encode (bundle                            ;; valley at 3400 (capitulation)
  (atom "phase-valley")
...
(define phase-2 (encode (bundle                            ;; first bounce (tentative)
...
(define phase-3 (encode (bundle                            ;; weak peak
  (atom "phase-peak")
...
(define phase-4 (encode (bundle                            ;; pullback — MUCH weaker than crash
  (atom "phase-transition-down")
  (bind (atom "rec-duration")         (log 8.0))
...
(define phase-5 (encode (bundle                            ;; valley at 3500 — HIGHER LOW
  (atom "phase-valley")
...
(define phase-6 (encode (bundle                            ;; stronger rally
  (atom "phase-transition-up")
...
(define phase-7 (encode (bundle                            ;; peak
  (atom "phase-peak")
  (bind (atom "rec-duration")         (log 10.0))
...
(define phase-8 (encode (bundle                            ;; shallower pullback
  (atom "phase-transition-down")
...
(define phase-9 (encode (bundle                            ;; valley at 3580 — ANOTHER higher low
  (atom "phase-valley")
  (bind (atom "rec-duration")         (log 10.0))
  (bind (atom "rec-move")             (linear -0.002 1.0))
