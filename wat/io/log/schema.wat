;; :lab::log::schema-* — DDL strings, one per LogEntry variant.
;;
...
;; `:lab::rundb::Service` driver iterates `:lab::log::all-schemas`
...
;; Future variants append: (:lab::log::schema-telemetry), etc.
(:wat::core::define
