...
(:deftest :trading::test::encoding::indicator-bank::test-divergence-short-zero
  (:wat::core::let*
    (((prices :Vec<f64>) (:wat::core::vec :wat::core::f64 100.0 101.0))
     ((rsis :Vec<f64>) (:wat::core::vec :wat::core::f64 50.0 51.0))
     ((d :(f64,f64))
      (:trading::encoding::detect-divergence prices rsis))
     ((bull :wat::core::f64) (:wat::core::first d))
     ((bear :wat::core::f64) (:wat::core::second d)))
    (:wat::core::let*
...
(:deftest :trading::test::encoding::indicator-bank::test-divergence-bull-detected
  (:wat::core::let*
    (((prices :Vec<f64>)
      ...
      (:wat::core::vec :wat::core::f64 100.0 102.0 100.0 98.0 95.0 96.0))
     ((rsis :Vec<f64>)
      ;; First half lows ~30; second half makes higher low ~35.
      (:wat::core::vec :wat::core::f64 30.0 35.0 32.0 35.0 38.0 40.0))
     ((d :(f64,f64))
      (:trading::encoding::detect-divergence prices rsis))
     ((bull :wat::core::f64) (:wat::core::first d)))
...
(:deftest :trading::test::encoding::indicator-bank::test-divergence-flat-zero
  (:wat::core::let*
    (((prices :Vec<f64>)
      (:wat::core::vec :wat::core::f64 100.0 100.0 100.0 100.0 100.0 100.0))
     ((rsis :Vec<f64>)
      (:wat::core::vec :wat::core::f64 50.0 50.0 50.0 50.0 50.0 50.0))
     ((d :(f64,f64))
      (:trading::encoding::detect-divergence prices rsis))
     ((bull :wat::core::f64) (:wat::core::first d))
     ((bear :wat::core::f64) (:wat::core::second d)))
