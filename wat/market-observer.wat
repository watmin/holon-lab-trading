...
; Cache misses are returned as the fourth value — values up, not queues down.
...
;;
;; Returns: (list thought pred edge misses) — FOUR values.
;; thought: Vector, pred: Prediction (Up/Down), edge: f64 (curve-valid),
;; misses: Vec<(ThoughtAST, Vector)> — cache misses from encoding.
