...
;;
;; Depends on: nothing
;; Side, Direction, Outcome, TradePhase, MarketLens, ExitLens,
;; reckoner-config, prediction, ScalarEncoding, ThoughtAST
...
;; FOUR variants. Active + tp -> Runner directly (principal recovery
;; is implied by the transition, not a separate phase).
