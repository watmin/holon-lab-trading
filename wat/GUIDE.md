...
```mermaid
%% Render: curl https://mermaid-ascii.art -d mermaid="paddingX = 2 ..."
%% Source: https://github.com/AlexanderGrooff/mermaid-ascii
%% Options: paddingX (horiz spacing), paddingY (vert spacing), borderPadding (text-to-border)
paddingX = 2
paddingY = 1
graph LR
...
+--------------------+||+----------------+          +-----------------------+ |
           ...
           |          ||+----------------+          +-----------------------+ |
           |          |||                |          |                       | |
       Direction      |||       TE       |-Vector-->| MO[MarketObserver x6] | |
           |          |||                |          |                       | |
           |          ||+----------------+          +-----------------------+ |
       Distances      ||                                                      |
           |          ||                                                      |
