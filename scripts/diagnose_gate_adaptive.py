"""Adaptive gate diagnostic: regime subspaces learn online.

Same as diagnose_gate_fast.py but with adaptive=True: the winning
regime's subspace absorbs each new window after scoring it.
Score first, update second — core Holon principle.

This tests whether online learning fixes the frozen-geometry problem.

Usage:
    ./scripts/run_with_venv.sh python holon-lab-trading/scripts/diagnose_gate_adaptive.py
"""
...
def main():
    ...
    for period_name, start, end in periods:
        ...
        # Don't reset gate between periods — learning accumulates
        # Only reset tenure/regime tracking for clean transition counting
        gate._tenure = 0
